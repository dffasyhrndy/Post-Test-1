...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.print("Silahkan Pilih Menu: "); // <- diganti print
            ...
            switch (pilihan) {
                case 1:
                    System.out.print("Masukkan Nama Kegiatan/Tugas: "); // <- print
                    String nama = input.nextLine();
                    System.out.print("Tanggal/Deadline Kegiatan/Tugas: "); // <- print
                ...
                case 3:
                    ...
                    System.out.print("Pilih nomor kegiatan yang ingin diubah: "); // <- print
                    int idx = input.nextInt() - 1;
                    input.nextLine();

                    if (idx >= 0 && idx < namaKegiatan.size()) {
                        System.out.print("Update Nama Kegiatan: "); // <- print
                        String newNama = input.nextLine();
                        if (!newNama.isEmpty()) {
                            namaKegiatan.set(idx, newNama);
                        }

                        System.out.print("Update Tanggal: "); // <- print
                        String newTanggal = input.nextLine();
                        if (!newTanggal.isEmpty()) {
                            tanggal.set(idx, newTanggal);
                        }

                        System.out.print("Update Status Kegiatan: "); // <- print
                ...
                case 4:
                    ...
                    System.out.print("Pilih nomor kegiatan yang ingin dihapus: "); // <- print
